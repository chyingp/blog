...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'simple.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'simple.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'simple.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "simple.html.mem" : null;
