...
function() {
    ...
    function h(nodeName, attributes) {
        ...
        while (stack.length) {
            if ((child = stack.pop()) && void 0 !== child.pop) {
                ...
                if (simple = 'function' != typeof nodeName) if (null == child) child = '';
    ...
    function cloneElement(vnode, props) {
        return h(vnode.nodeName, extend(extend({},
        vnode.attributes), props), arguments.length > 2 ? [].slice.call(arguments, 2) : vnode.children);
    }
    ...
    function setAccessor(node, name, old, value, isSvg) {
        ...
        if ('key' === name);
            ...
            } else node.removeEventListener(name, eventProxy, useCapture); (node.__l || (node.__l = {}))[name] = value;
        } else if ('list' !== name && 'type' !== name && !isSvg && name in node) {
            setProperty(node, name, null == value ? '': value);
            if (null == value || !1 === value) node.removeAttribute(name);
        } else {
            var ns = isSvg && name !== (name = name.replace(/^xlink:?/, ''));
            if (null == value || !1 === value) if (ns) node.removeAttributeNS('http://www.w3.org/1999/xlink', name.toLowerCase());
    ...
    function idiff(dom, vnode, context, mountAll, componentRoot) {
        ...
        if (null == props) {
            ...
            i = a.length; i--;) props[a[i].name] = a[i].value;
        }
    ...
    function innerDiffNode(dom, vchildren, context, mountAll, isHydrating) {
        ...
        if (0 !== vlen) for (var i = 0; i < vlen; i++) {
            ...
            if (child && child !== dom && child !== f) if (null == f) dom.appendChild(child);
    ...
    function setComponentProps(component, props, opts, context, mountAll) {
        if (!component.__x) {
            ...
            component.__x = !1;
            if (0 !== opts) if (1 === opts || !1 !== options.syncComponentUpdates || !component.base) renderComponent(component, 1, mountAll);
    ...
    function renderComponent(component, opts, mountAll, isChild) {
        if (!component.__x) {
            ...
            if (!skip) {
                ...
                if (component.getChildContext) context = extend(extend({},
