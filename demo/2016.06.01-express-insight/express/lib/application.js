...
app.use = function use(fn) {
  ...
  // 备注：下面的 callback 也可能是数组
  // app.use(callback);
  // app.use('/user', callback);
  // app.use(['/user, 'users/], callback)
  ...
  // 从 this.lazyrouter 的调用时机来看，可以在添加中间件之前
  // 通过 app.set('case sensitive routing', true) 等来预先修改路由相关的配置文件
  // setup router
  this.lazyrouter();
  var router = this._router;
  ...
  fns.forEach(function (fn) {
    ...
    fn.mountpath = path;  // 如果是 sub app，那么 moutpath 设置为 path
    fn.parent = this;  // 设置 parent
 ...
 */
// 根据 HTTP 模块支持的 method，往 app 上挂靠方法
